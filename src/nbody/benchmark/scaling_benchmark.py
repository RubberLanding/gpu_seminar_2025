...
from nbody.benchmark.util import cleanup_gpu
...
def run_scaling_benchmark(measure_time_func, n_particles, compute_forces=None, **kwargs):
    results = []
    max_wait_time = 180.0 # Don't run a size if 1 step takes > 180s
...
if __name__== "__main__":
    ...
    # Generate cubic particle counts
